...
"@
	...
	if (-not $AsContainer) {
		Install-PowerShellApplicationUniversalDashboard @Parameters -UseTLS
	} elseif ($AsContainer) {
		Invoke-PowerShellApplicationDockerBuild @Parameters -UseTLS
		# docker run -dit --name terviscustomer -P terviscustomerv1
		# docker run -d --name terviscustomer -P terviscustomerv1
		# docker exec -it terviscustomer pwsh
		# docker run --name terviscustomer -P terviscustomerv1
	}
}